...
namespace Company.Function
{
    public class GetVisitorCounter
    {
        ...
        [CosmosDBInput(databaseName: "AzureResumeDB", collectionName: "Counter", ConnectionStringSetting = "AzureResumeConnectionString", Id = "index",
    ...
    {
        [CosmosDBOutput(databaseName: "AzureResumeDB", collectionName: "Counter", ConnectionStringSetting = "AzureResumeConnectionString")]
